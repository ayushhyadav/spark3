...
function Volve() {
  ...
  return (
    <div className="main-container">
      <div>
        <img src="assets/img6.webp" width={"750px"}></img>
        <div>
          <span></span>
          <span></span>
        </div>
      ...
      <div className="main-containt">
        <div className="uppar-containt">
          ...
          <div>
            <b style={{ fontSize: "1.3rem" }}>VOLVE Smart Home Speaker</b>{" "}
            <br></br>
            <b>
              <s>$550.00 </s> $412.50
            </b>
          ...
          <button className="cart-btn" onClick={() => console.log("ok")}>
            Add to Cart
          </button>
          <div>
            <b>
              I'm a product overview. I’m a great place to include more
      ...
      <div className="side-bar">
        <span className="close-btn" id="mySidenav" onClick={closeNav}>
          {" "}
          &times;{" "}
        </span>
      </div>
